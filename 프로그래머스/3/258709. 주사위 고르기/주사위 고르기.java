...
class Solution {
    ...
    public static List<int[]> getCombinations(int n, int r) {
        List<int[]> result = new ArrayList<>();
        combinationHelper(new int[r], 0, 0, n, result);
        return result;
    }

    private static void combinationHelper(int[] temp, int depth, int start, int n, List<int[]> result) {
    ...
    public static List<Integer> getAllSums(int[][] dice, int[] chosen) {
    ...
    // 이진 탐색
    private static int binarySearch(List<Integer> B, int a) {
